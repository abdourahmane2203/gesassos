...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="../src/view/assets/images/favicon.ico" type="image/x-icon">
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
    <!-- waves.css -->
    <link rel="stylesheet" href="../src/view/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="../src/view/assets/css/bootstrap/css/bootstrap.min.css">
    <!-- waves.css -->
    <link rel="stylesheet" href="../src/view/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- themify icon -->
    <link rel="stylesheet" type="text/css" href="../src/view/assets/icon/themify-icons/themify-icons.css">
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="../src/view/assets/css/font-awesome-n.min.css">
    <link rel="stylesheet" type="text/css" href="../src/view/assets/css/font-awesome.min.css">
    <!-- scrollbar.css -->
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <!-- <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="../src/view/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                    ...
                                    <!-- <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="../src/view/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="p-15 p-b-0">
                                <form class="form-material">
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label"><i class="fa fa-search m-r-10"></i>Search Members</label>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="pcoded-navigation-label">Organisations</div>
                            <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="/gesassos/membres/add" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Membre</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Ville de Mbour</h5>
                                            <p class="m-b-0">Bienvenu sur votre plateforme de gestion des organisations</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
